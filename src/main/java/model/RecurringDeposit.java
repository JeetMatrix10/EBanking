...
public class RecurringDeposit {
    ...
    public int getNoOfMonths() { return noOfMonths; }
    public void setNoOfMonths(int noOfMonths) { this.noOfMonths = noOfMonths; }
    ...
    public Timestamp getBookDate() { return bookDate; }
    public void setBookDate(Timestamp bookDate) { this.bookDate = bookDate; }

    public Timestamp getNextDebitDate() { return nextDebitDate; }
    public void setNextDebitDate(Timestamp nextDebitDate) { this.nextDebitDate = nextDebitDate; }
