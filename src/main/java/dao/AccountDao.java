...
public class AccountDao {
	...
	// every dropdown across the project (deposit, withdraw, transfer, FD, RD)
	// needs to show more than a bare number — e.g. "ACC00001 (Saving - Balance:
	// 5000.00)" — so returning full Account objects avoids a second query per
	// account just to get its type/balance for display.
	...
	// a dedicated method makes the INTENT ("check ownership") clear at the call
	// site.
