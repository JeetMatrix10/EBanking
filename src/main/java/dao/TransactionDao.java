...
public class TransactionDao {
	...
	// history page needs every past transaction for their account, not just one row.
	public List<Transaction> getTransactionsByAccno(String accno) {
	    ...
	    try (Connection conn = ConnectionFactory.getConnection();
	        ...
	        // checked to show the account's complete history, not just outgoing transactions.
	...
	// Why the method signature changed from "boolean ... throws InsufficientBalanceException"
