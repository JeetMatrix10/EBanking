...
<!DOCTYPE html>
<html>
<head><title>My Recurring Deposits - EBanking</title></head>
<body>
    <h2>My Recurring Deposits</h2>
    <%
        List<RecurringDeposit> rds = (List<RecurringDeposit>) request.getAttribute("rds");
        if (rds == null) { response.sendRedirect("myRDs"); return; }
    %>
    <% if (rds.isEmpty()) { %>
        <p>You have no Recurring Deposits yet.</p>
    <% } else { %>
        <table border="1" cellpadding="5">
            <tr><th>RD ID</th><th>Account</th><th>Monthly Amt</th><th>Months</th><th>Paid</th><th>Next Debit</th><th>Status</th></tr>
